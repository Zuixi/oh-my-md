...
LangString dontUninstallDowngrade ${LANG_SIMPCHINESE} "不卸载（此安装程序禁止未卸载就进行版本降级）"
...
LangString newerVersionInstalled ${LANG_SIMPCHINESE} "已安装较新版本的 ${PRODUCTNAME}。不建议安装旧版本；若确需安装，建议先卸载当前版本。选择要执行的操作，然后点击「下一步」继续。"
LangString older ${LANG_SIMPCHINESE} "较旧"
LangString olderOrUnknownVersionInstalled ${LANG_SIMPCHINESE} "系统中已存在版本为 $R4 的 ${PRODUCTNAME}。建议先卸载后再安装。选择要执行的操作，然后点击「下一步」继续。"
LangString silentDowngrades ${LANG_SIMPCHINESE} "此安装程序已禁用降级，无法静默安装。请使用图形界面安装程序。$\n"
...
LangString webview2AbortError ${LANG_SIMPCHINESE} "WebView2 安装失败，应用无法运行。请重新运行安装程序。"
