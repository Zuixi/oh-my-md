export const zh: Record<string, string> = {
  ...
  "largeDoc.readonly": "超大文档（{lines} 行）已按只读纯文本打开。如需编辑，建议先拆分文件。",
  ...
  "confirm.largeOpen": "{label} 有 {mb} MB，大文件将以源码模式打开且可能需要一些时间。要打开吗？",
  "confirm.readonlyOpen": "{label} 有 {mb} MB，过大而不适合编辑。要以只读纯文本方式打开吗？",
