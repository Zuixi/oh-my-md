export const en: Record<string, string> = {
  ...
  "update.available": "oh-my-md {version} is available.",
  "update.download": "Download update",
  "update.viewRelease": "View release",
  "update.openRelease": "Open Release",
  "update.later": "Later",
  "update.hide": "Hide",
  "update.downloading": "Downloading oh-my-md {version}…",
  "update.downloadProgress": "{downloaded} of {total} ({percent}%)",
  "update.downloaded": "oh-my-md {version} is ready to install.",
  "update.requestInstall": "Restart and install",
  "update.blocked": "oh-my-md can restart to install {version} after you resolve these documents:",
  "update.blockedItem": "{name} — {reason}",
  "update.block.dirtyDocument": "Unsaved changes",
  "update.block.saveConflict": "Save conflict",
  "update.block.saveFailed": "Save failed",
  "update.block.pendingNormalization": "Ordered-list review pending",
  "update.block.openOperation": "Opening the file",
  "update.block.activeSave": "Currently saving",
  "update.focusBlocked": "View first problem document",
  "update.readyToInstall": "Installing will close and restart oh-my-md. All of your documents are saved.",
  "update.installing": "Installing oh-my-md {version}…",
  "update.failure.network": "Could not reach the update service. Check your connection and try again.",
  "update.failure.manifest": "The update information could not be read.",
  "update.failure.signature": "The update could not be verified.",
  "update.failure.download": "The download failed. Try again later.",
  "update.failure.platformUnsupported": "Automatic updates are not available for this installation.",
  "update.failure.flushTimeout": "oh-my-md did not finish saving session state in time, so the update was not installed. Your documents are safe.",
  "update.failure.install": "The update could not be installed.",
  "update.failure.unknown": "An unexpected error occurred.",
  "update.current": "oh-my-md is up to date.",
  "update.releaseOpenFailed": "Could not open the Release page.",
