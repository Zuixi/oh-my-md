export const en: Record<string, string> = {
  ...
  "largeDoc.readonly": "Very large document ({lines} lines) opened read-only as plain text. Consider splitting the file to edit it.",
  "largeDoc.dismiss": "OK",
  ...
  "confirm.largeOpen": "{label} is {mb} MB; large files open in source mode and may take a moment. Open it?",
  "confirm.readonlyOpen": "{label} is {mb} MB — too large to edit comfortably. Open it read-only as plain text?",
